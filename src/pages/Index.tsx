  ...
  return (
    <div style={{ background: warm, color: dark, overflowX: "hidden" }}>
      ...
      <Slide bg={dark} style={{ color: warm }}>
        <Big size="clamp(1.5rem,3vw,2.2rem)" color={soft} weight={400}>What is Cancer? <br /><br /><Big size="clamp(1.5rem,3vw,2.2rem)" color={soft} weight={400}>What is Cancer? <br /><br />Cancer is when one part starts to feeds on the whole where...</Big></Big>
        <Spacer h={16} />
        <Reveal delay={0.15}>
